const tr = {
  ...
  "settings.ratesHint":
    "Toplamlar seçili dilin para biriminde hesaplanır (Türkçe → ₺, English → $, Melayu → RM). Kurlar Avrupa Merkez Bankası verisinden günde bir çekilir; çevrimdışıyken son bilinen kur kullanılır.",
  "settings.theme": "Tema",
...
const en: Record<TranslationKey, string> = {
  ...
  "settings.ratesHint":
    "Totals are calculated in your language's currency (Türkçe → ₺, English → $, Melayu → RM). Rates come from European Central Bank data once a day; the last known rates are used offline.",
...
const ms: Partial<Record<TranslationKey, string>> = {
  ...
  "settings.ratesHint":
    "Jumlah dikira dalam mata wang bahasa pilihan anda (Türkçe → ₺, English → $, Melayu → RM). Kadar diambil daripada data Bank Pusat Eropah sekali sehari; kadar terakhir digunakan semasa luar talian.",
  "settings.theme": "Tema",
