const tr = {
  ...
  "action.undo": "Geri al",
  "toast.advanced": "Vade bir dönem ileri sarıldı.",
  "toast.undoDone": "İşlem geri alındı.",
  ...
  "list.noResultsFor": "\"{query}\" ile eşleşen ödeme yok.",
  "list.noResultsFiltered": "Bu filtreyle eşleşen ödeme yok.",
  "list.clearFilters": "Arama ve filtreleri temizle",
  "list.count": "{n} ödeme gösteriliyor",
  ...
  "security.error.mismatch": "PIN'ler eşleşmiyor.",
  "security.error.length": "PIN 4-8 hane olmalı.",
  "security.pinHint": "4-8 haneli bir sayı belirle.",
  "settings.notifDeniedHint": "Bildirimler bu tarayıcıda bu site için engelli. Tarayıcının site ayarlarından izin verip tekrar dene.",
  "settings.discardWarn": "Kaydedilmemiş değişiklikler var. Kapatılsın mı?",
  "settings.discardConfirm": "Değişiklikleri at",
  "lock.pinHint": "4-8 haneli PIN",
  ...
  "csv.reason.short": "eksik satır",
  "csv.reason.name": "eksik ad",
  "csv.reason.price": "geçersiz tutar",
  "csv.reason.currency": "bilinmeyen para birimi",
  "csv.reason.cycle": "geçersiz dönem",
  "csv.reason.category": "bilinmeyen kategori",
  "csv.reason.date": "geçersiz tarih",
  ...
  "auth.profile.syncBlocked": "Buluttaki kayıt bu cihazda açılamadı; eşitleme yazımı güvenlik için duraklatıldı.",
...
const en: Record<TranslationKey, string> = {
  ...
  "action.undo": "Undo",
  "toast.advanced": "Due date moved to the next period.",
  "toast.undoDone": "Action undone.",
  "aria.edit": "Edit {name}",
  ...
  "list.noResultsFor": "No payments match \"{query}\".",
  "list.noResultsFiltered": "No payments match these filters.",
  "list.clearFilters": "Clear search and filters",
  "list.count": "Showing {n} payments",
  ...
  "security.error.mismatch": "PINs don't match.",
  "security.error.length": "PIN must be 4-8 digits.",
  "security.pinHint": "Choose a 4-8 digit number.",
  "settings.notifDeniedHint": "Notifications are blocked for this site in your browser. Allow them in the browser's site settings and try again.",
  "settings.discardWarn": "You have unsaved changes. Close anyway?",
  "settings.discardConfirm": "Discard changes",
  "lock.pinHint": "4-8 digit PIN",
  ...
  "csv.reason.short": "incomplete row",
  "csv.reason.name": "missing name",
  "csv.reason.price": "invalid amount",
  "csv.reason.currency": "unknown currency",
  "csv.reason.cycle": "invalid cycle",
  "csv.reason.category": "unknown category",
  "csv.reason.date": "invalid date",
  ...
  "auth.profile.syncBlocked": "The cloud record couldn't be opened on this device; writing to the cloud is paused for safety.",
...
const ms: Partial<Record<TranslationKey, string>> = {
  ...
  "action.undo": "Buat asal",
  "toast.advanced": "Tarikh bayar diteruskan ke tempoh seterusnya.",
  "toast.undoDone": "Tindakan dibuat asal.",
  "aria.edit": "Edit {name}",
  ...
  "list.noResultsFor": "Tiada bayaran sepadan dengan \"{query}\".",
  "list.noResultsFiltered": "Tiada bayaran sepadan dengan penapis ini.",
  "list.clearFilters": "Kosongkan carian dan penapis",
  "list.count": "Menunjukkan {n} bayaran",
  ...
  "security.error.mismatch": "PIN tidak sepadan.",
  "security.error.length": "PIN mesti 4-8 digit.",
  "security.pinHint": "Pilih nombor 4-8 digit.",
  "settings.notifDeniedHint": "Pemberitahuan disekat untuk laman ini dalam pelayar anda. Benarkan dalam tetapan laman pelayar dan cuba lagi.",
  "settings.discardWarn": "Anda mempunyai perubahan yang belum disimpan. Tutup jua?",
  "settings.discardConfirm": "Buang perubahan",
  "lock.pinHint": "PIN 4-8 digit",
  ...
  "csv.reason.short": "baris tidak lengkap",
  "csv.reason.name": "nama tiada",
  "csv.reason.price": "jumlah tidak sah",
  "csv.reason.currency": "mata wang tidak dikenali",
  "csv.reason.cycle": "kitaran tidak sah",
  "csv.reason.category": "kategori tidak dikenali",
  "csv.reason.date": "tarikh tidak sah",
  ...
  "auth.profile.syncBlocked": "Rekod awan tidak dapat dibuka pada peranti ini; penulisan dijeda untuk keselamatan.",
...
const es: Record<TranslationKey, string> = {
  ...
  "toast.advanced": "La fecha de pago pasó al siguiente periodo.",
  "toast.undoDone": "Acción deshecha.",
  ...
  "list.noResultsFor": "No hay pagos que coincidan con \"{query}\".",
  "list.noResultsFiltered": "No hay pagos que coincidan con estos filtros.",
  "list.clearFilters": "Borrar búsqueda y filtros",
  "list.count": "Mostrando {n} pagos",
  ...
  "autolock.minutes": "{n} min",
  "security.error.mismatch": "Los PIN no coinciden.",
  "security.error.length": "El PIN debe tener entre 4 y 8 dígitos.",
  "security.pinHint": "Elige un número de 4 a 8 dígitos.",
  "settings.notifDeniedHint": "Las notificaciones están bloqueadas para este sitio en tu navegador. Permítelas en la configuración del sitio e inténtalo de nuevo.",
  "settings.discardWarn": "Tienes cambios sin guardar. ¿Cerrar de todos modos?",
  "settings.discardConfirm": "Descartar cambios",
  "lock.pinHint": "PIN de 4 a 8 dígitos",
  ...
  "csv.reason.short": "fila incompleta",
  "csv.reason.name": "falta el nombre",
  "csv.reason.price": "importe no válido",
  "csv.reason.currency": "moneda desconocida",
  "csv.reason.cycle": "ciclo no válido",
  "csv.reason.category": "categoría desconocida",
  "csv.reason.date": "fecha no válida",
  ...
  "auth.profile.syncBlocked": "El registro de la nube no se pudo abrir en este dispositivo; la escritura está en pausa por seguridad.",
...
const ar: Record<TranslationKey, string> = {
  ...
  "action.undo": "تراجع",
  "toast.advanced": "تم تأجيل تاريخ الدفع إلى الفترة التالية.",
  "toast.undoDone": "تم التراجع عن الإجراء.",
  ...
  "list.noResultsFor": "لا توجد مدفوعات تطابق \"{query}\".",
  "list.noResultsFiltered": "لا توجد مدفوعات تطابق هذه المرشحات.",
  "list.clearFilters": "مسح البحث والمرشحات",
  "list.count": "يتم عرض {n} من المدفوعات",
  ...
  "security.error.mismatch": "الرقمان السريان غير متطابقين.",
  "security.error.length": "يجب أن يتكوّن الرقم السري من 4 إلى 8 خانات.",
  "security.pinHint": "اختر رقماً من 4 إلى 8 خانات.",
  "settings.notifDeniedHint": "الإشعارات محظورة لهذا الموقع في متصفحك. اسمح بها من إعدادات الموقع في المتصفح ثم أعد المحاولة.",
  "settings.discardWarn": "لديك تغييرات غير محفوظة. إغلاق على أي حال؟",
  "settings.discardConfirm": "تجاهل التغييرات",
  "lock.pinHint": "رقم سري من 4 إلى 8 خانات",
  ...
  "csv.reason.short": "صف ناقص",
  "csv.reason.name": "الاسم مفقود",
  "csv.reason.price": "مبلغ غير صالح",
  "csv.reason.currency": "عملة غير معروفة",
  "csv.reason.cycle": "دورة غير صالحة",
  "csv.reason.category": "فئة غير معروفة",
  "csv.reason.date": "تاريخ غير صالح",
  ...
  "auth.profile.syncBlocked": "تعذّر فتح سجل السحابة على هذا الجهاز؛ تم إيقاف الكتابة مؤقتاً لأسباب أمنية.",
